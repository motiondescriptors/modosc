...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Runs the Skogstad low-pass-filter (i.e. noise reduction) on position data. The amount of filtering (specififed as [1,2,3,4, or 5], corresponds to normalized cutoff frequencies of [0.5, 0.4, 0.3, 0.2, and 0.1]. \nNote: if you use it, it is best to put it after mo.velocityLPF and mo.accelerationLPF in the chain, since doing otherwise might result in more filtering taking place than you intend."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 422.5, 131.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.5, 127.286255, 227.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 398.0, 185.115753, 57.0, 22.0 ],
					"style" : "",
					"text" : "zl.slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.5, 127.286255, 63.0, 20.0 ],
					"style" : "",
					"text" : "data input"
				}
...
,
					"patching_rect" : [ 158.75, 196.115753, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.75, 121.764801, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 158.75, 160.240295, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.0, 1186.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.25, 121.764801, 105.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.5, 340.5, 63.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 731.0, 275.5, 263.0, 73.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 158.75, 226.0, 96.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 158.75, 255.0, 510.0, 59.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 21.0, 1135.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "o.route /state"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 762.0, 250.5, 281.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 21.0, 421.5, 50.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 21.0, 372.5, 30.0, 22.0 ],
					"style" : "",
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 707.5, 239.811462, 42.5, 22.0 ],
					"style" : "",
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 707.5, 199.696167, 215.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 757.0, 129.866699, 150.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 707.5, 124.866699, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 398.0, 156.866699, 74.0, 22.0 ],
					"style" : "",
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 398.0, 127.286255, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 707.5, 170.115753, 85.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /points"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 20.5, 307.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.5, 1002.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.5, 121.764801, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 168.25, 324.0, 114.625, 324.0, 114.625, 296.0, 61.0, 296.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 717.0, 331.861633, 74.0, 331.861633 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 740.5, 388.5, 111.0, 388.5 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 405.5, 93.0, 405.5 ],
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 717.0, 161.991226, 717.0, 161.991226 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 407.5, 217.115753, 287.875, 217.115753, 287.875, 155.240295, 168.25, 155.240295 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 445.5, 217.115753, 581.25, 217.115753, 581.25, 161.115753, 717.0, 161.115753 ],
					"source" : [ "obj-51", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 93.0, 452.0, 75.75, 452.0, 75.75, 410.5, 61.5, 410.5 ],
					"source" : [ "obj-86", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-86", 1 ],
					"midpoints" : [ 30.5, 1171.0, 976.5, 1171.0, 976.5, 406.5, 111.0, 406.5 ],
					"source" : [ "obj-93", 0 ]
				}
