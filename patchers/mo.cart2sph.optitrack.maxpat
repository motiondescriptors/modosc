...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 80.0, 409.0, 20.0 ],
					"text" : "This version has y and z swapped in position and distance divided by 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 7.866699, 322.0, 41.0 ],
					"suppressinlet" : 1,
					"text" : "mo.cart2sph.optitrack",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 280.0, 48.0, 22.0 ],
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 42.0, 312.0, 653.0, 46.0 ],
