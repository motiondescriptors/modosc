...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 767.0, 99.0, 20.0 ],
					"text" : "Set a static point"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 259.5, 733.666687000000024, 97.0, 20.0 ],
					"text" : "set position now"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 228.0, 733.666687000000024, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 29.5, 766.0, 215.0, 22.0 ],
					"text" : "mo.newStaticPoint /newPoint /RBody1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1096.5, 315.0, 85.0, 20.0 ],
					"text" : "roll, pitch, yaw"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1596.6666259765625, 675.0, 84.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1438.5, 706.0, 85.0, 20.0 ],
					"text" : "roll, pitch, yaw"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1517.0, 675.0, 65.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1438.5, 675.0, 60.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1438.5, 646.0, 173.0, 22.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1174.5, 706.0, 41.0, 20.0 ],
					"text" : "x, y, z"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1330.0, 675.0, 71.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1253.0, 675.0, 71.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1174.5, 675.0, 71.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 1174.5, 646.0, 173.0, 22.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "FullPacket" ],
					"patching_rect" : [ 1174.5, 602.0, 371.0, 22.0 ],
					"text" : "o.route /modosc/points/RBody2/pos /modosc/points/RBody2/rot_rpy"
				}
...
,
						"classnamespace" : "box",
						"rect" : [ 1263.0, 187.0, 1099.0, 732.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 554.0, 397.0, 79.0, 22.0 ],
									"text" : "size 400 160"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 705.0, 83.0, 150.0, 33.0 ],
									"text" : "Not sure I understand this part yet -LD"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 29.5, 373.0, 177.0, 22.0 ],
					"text" : "mo.jerk 1 /BdyFrArm4 /RBody2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.5, 453.0, 200.0, 20.0 ],
					"text" : "Insert other point descriptors here..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 890.0, 449.5, 150.0, 47.0 ],
					"text" : "Send data from here to your sound provessing / generation code."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 813.0, 489.0, 37.0, 20.0 ],
					"text" : "QoM"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 813.0, 462.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 568.5, 493.0, 41.0, 20.0 ],
					"text" : "x, y, z"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 703.0, 150.0, 20.0 ],
					"text" : "Contraction Index"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 662.0, 150.0, 20.0 ],
					"text" : "Bounding Box"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 626.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 578.0, 150.0, 33.0 ],
					"text" : "Set weights for the points in the group"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 534.0, 150.0, 33.0 ],
					"text" : "Calculate the centroid & store in a new point"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 484.0, 150.0, 20.0 ],
					"text" : "Make a group"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 413.0, 123.0, 20.0 ],
					"text" : "Smooth position data"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 233.333327999999995, 123.0, 199.0, 20.0 ],
					"text" : "Reformat data from Qtm to modosc"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 724.0, 462.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 647.0, 462.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 568.5, 462.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 568.5, 433.0, 173.0, 22.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "FullPacket" ],
					"patching_rect" : [ 568.5, 406.0, 373.0, 22.0 ],
					"text" : "o.route /modosc/points/RBody2/pos /modosc/groups/mygroup1/qom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 29.5, 703.0, 177.0, 22.0 ],
					"text" : "mo.contractionIndex /mygroup1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 29.5, 662.0, 161.0, 22.0 ],
					"text" : "mo.boundingBox /mygroup1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 29.5, 626.0, 114.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 29.5, 578.0, 183.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 29.5, 534.0, 197.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "" ],
					"patching_rect" : [ 29.5, 413.0, 203.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "" ],
					"patching_rect" : [ 29.5, 337.0, 222.0, 22.0 ],
					"text" : "mo.acceleration 1 /BdyFrArm4 /RBody2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.5, 247.240295000000003, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 109.5, 269.240295000000003, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "" ],
					"patching_rect" : [ 29.5, 298.0, 177.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.0, 258.24029541015625, 180.0, 33.0 ],
					"text" : "Some objects can take patcher args or lists in the right inlet"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 29.5, 484.0, 220.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 295.5, 298.0, 155.0, 22.0 ],
					"text" : "/RBody1 /RBody2 /RBody3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 29.5, 221.800003000000004, 191.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 122.758301000000003, 431.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 161.258300999999989, 257.0, 24.0, 24.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.5, 26.0, 308.0, 47.0 ],
					"text" : "This patch shows how to get started with using modosc for calculating various motion descriptors from data coming from qualisys."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 29.5, 123.0, 75.0, 22.0 ],
					"text" : "o.route /qtm"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.5, 91.0, 144.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-36", 0 ],
					"midpoints" : [ 571.0, 397.5, 555.0, 397.5 ],
					"order" : 2,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 571.0, 367.166687000000024, 1184.0, 367.166687000000024 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
